        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT p.*,v.code, v.publisher_name as `vendor` from `product_list` p inner join author_list v on p.author_id = v.id where p.delete_flag = 0 order by p.`name` asc ");
