...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT * from `publisher_type_list` where id = '{$_GET['id']}' and delete_flag = 0 ");
    if($qry->num_rows > 0){
...
?>
		<center>Unknown Publisher Type</center>
		<style>
...
<div class="container-fluid">
	<form action="" id="publisher_type-form">
...
<script>
	...
	$(document).ready(function(){
		$('#uni_modal #publisher_type-form').submit(function(e){
			e.preventDefault();
            var _this = $(this)
			 $('.err-msg').remove();
			...
			start_loader();
			$.ajax({
				url:_base_url_+"classes/Master.php?f=save_publisher_type",
