                    ...
                    <table class="table table-bordered table-stripped">
                        ...
                        <thead>
                            <tr class="">
                                ...
                                <th class="text-center align-middle py-1">Author</th>
                        ...
                        <tbody>
                            ...
                            $i = 1;
                            $total = 0;
                            $orders = $conn->query("SELECT o.*,c.code as ccode, CONCAT(c.lastname, ', ',c.firstname,' ',COALESCE(c.middlename,'')) as client,concat(v.code, '-',v.publisher_name) as author from `order_list` o inner join client_list c on o.client_id = c.id inner join author_list v on o.author_id = v.id where date_format(o.date_created,'%Y-%m') = '{$month}' order by unix_timestamp(o.date_created) desc ");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="align-middle px-2 py-1"><?php echo ucwords($row['author']) ?></td>
