        ...
        <div class="d-flex justify-content-between w-100">
          ...
          <div>
            ...
            <?php else: ?>
              ...
              <a href="./author" class="mx-2 text-light text-decoration-none font-weight-bolder">Author Login</a> | 
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a href="./?page=products" class="nav-link <?= isset($page) && $page =='products' ? "active" : "" ?>">Books</a>
              </li>
              <li class="nav-item">
