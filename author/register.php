                    ...
                    <form id="vregister-frm" action="" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="publisher_name" autofocus name="publisher_name" class="form-control form-control-sm form-control-border" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="shop_owner" class="control-label">author Fullname</label>
                                <input type="text" id="publisher_owner" name="publisher_owner" class="form-control form-control-sm form-control-border" required>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select type="text" id="shop_type_id" name="publisher_type_id" class="form-control form-control-sm form-control-border select2" required>
                                    <option value="" disabled selected></option>
                                    <?php 
                                    $types = $conn->query("SELECT * FROM `publisher_type_list` where delete_flag = 0 and `status` = 1 order by `name` asc ");
...
<script>
  ...
  $(function(){
    ...
    $('#vregister-frm').submit(function(e){
        ...
        start_loader();
        $.ajax({
            url:_base_url_+"classes/Users.php?f=save_author",
