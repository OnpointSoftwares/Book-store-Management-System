        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT * from `product_list` where delete_flag = 0 and `author_id` = '{$_settings->userdata('id')}' order by `name` asc ");
...
<script>
	$(document).ready(function(){
		$('#create_new').click(function(){
			uni_modal('Add New Book',"products/manage_product.php",'large')
		})
