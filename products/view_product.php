...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT  p.*, v.publisher_name as author, c.name as `category` FROM `product_list` p inner join author_list v on p.author_id = v.id inner join category_list c on p.category_id = c.id where p.delete_flag = 0 and p.id = '{$_GET['id']}'");
    if($qry->num_rows > 0){
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-7 col-sm-12">
                        ...
                        <div class="d-flex w-100">
                            ...
                            <div class="col-auto px-0 flex-shrink-1 flex-grow-1"><p class="m-0"><small class="text-muted"><?= $author ?></small></p></div>
                        </div>
                        <div class="d-flex">
